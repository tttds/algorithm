...
//-----------------------------------------
  ...
  echo query(1, 2).PHP_EOL; // 3 (3, 2)
  echo query(1, 3).PHP_EOL; // 3 (3, 2, 1)
  echo query(3, 3).PHP_EOL; // 1 (1)
  echo query(1, 4).PHP_EOL; // 6 (3, 2, 1, 6)
  echo query(1, 5).PHP_EOL; // 6 (3, 2, 1, 6, 5)
  echo query(1, 6).PHP_EOL; // 6 (3, 2, 1, 6, 5, 4)
  echo query(6, 6).PHP_EOL; // 4 (4)

  echo "---------------------".PHP_EOL;
  add(1, 3, 3);
  echo query(1, 1).PHP_EOL; // 6 (6)
  echo query(1, 2).PHP_EOL; // 6 (6, 5)
  echo query(1, 3).PHP_EOL; // 6 (6, 5, 4)
  echo query(3, 3).PHP_EOL; // 4 (4)
  echo query(1, 4).PHP_EOL; // 6 (6, 5, 4, 6)
  echo query(1, 5).PHP_EOL; // 6 (6, 5, 4, 6, 5)
  echo query(1, 6).PHP_EOL; // 6 (6, 5, 4, 6, 5, 4)
  echo query(6, 6).PHP_EOL; // 4 (4)
  ...
  echo query(1, 1).PHP_EOL; // 6 (6)
  echo query(1, 2).PHP_EOL; // 6 (6, 5)
  echo query(1, 3).PHP_EOL; // 8 (6, 5, 8)
  echo query(3, 3).PHP_EOL; // 8 (8)
  echo query(1, 4).PHP_EOL; // 10 (6, 5, 8, 10)
  echo query(1, 5).PHP_EOL; // 10 (6, 5, 8, 10, 9)
  echo query(4, 4).PHP_EOL; // 10 (10)
  echo query(1, 6).PHP_EOL; // 10 (6, 5, 8, 10, 9, 4)
  echo query(6, 6).PHP_EOL; // 4 (4)
